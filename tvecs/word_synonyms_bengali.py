...
#
bilingual_dict = bg.load_bilingual_dictionary('data/bilingual_dictionary/en-bn.txt')

vector_space_mapper = vm.VectorSpaceMapper(
    model_1=Word2Vec.load(
            os.path.join('data', 'models', 't-vex-english-model')
        ),
    model_2=KeyedVectors.load_word2vec_format('data/models/t-vex-bengali-model'),
